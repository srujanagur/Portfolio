  ...
  return (
    <div className="projects">
      <div className="eachProject">
        <div className="project-image">
          ...
          <p>
            ...
            recipes from multiple recipe provider helps to collect feedbacks and
            improvement options.
          </p>
          ...
          <button className="projectButton">
            <a href="https://github.com/srujanagur/recipe_app">project link</a>
          </button>
        </div>
      </div>
      <div className="eachProject">
      ...
      <div className="eachProject">
        ...
        <p>
          This application provides a glince of youtube from json file. In this
          Application I have used Sample Api, Bootstrap UI, React/Redux
        </p>
        <button className="projectButton">
